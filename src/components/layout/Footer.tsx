...
const socialLinks = [
  {
    name: "Facebook",
    href: "https://facebook.com/mzansimarket",
    icon: (
  ...
  {
    name: "Twitter",
    href: "https://twitter.com/mzansimarket",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: "Instagram",
    href: "https://instagram.com/mzansimarket",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: "LinkedIn",
    href: "https://linkedin.com/company/mzansimarket",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Connecting service providers with customers. Find skilled professionals
              for any task or offer your services to grow your business.
            </p>
